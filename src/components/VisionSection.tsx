...
export default function VisionSection() {
  ...
  return (
    <section id="vision" className="section-padding relative noise-bg">
      ...
      <div ref={ref} className="container mx-auto relative z-10">
        <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? "animate-fade-up" : "opacity-0"}`}>
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 gradient-text-white">BSDI Vision</h2>
