...
export const defaultLayers: LayersContent = {
  ...
  cards: [
    { id: "l1", title: "ADDRESSES", description: "Standardized address points across Bahrain.", image: "https://images.unsplash.com/photo-1520637836862-4d197d17c55a?w=600&q=80", link: "#" },
    { id: "l2", title: "ADMINBOUNDRY", description: "Administrative boundaries and governorate divisions.", image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?w=600&q=80", link: "#" },
    { id: "l3", title: "APPROVED_ZONES", description: "Officially approved planning and development zones.", image: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=600&q=80", link: "#" },
    { id: "l4", title: "BACA", description: "Bahrain Authority for Culture & Antiquities sites.", image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=600&q=80", link: "#" },
    ...
    { id: "l6", title: "BIX", description: "Bahrain Internet Exchange node locations.", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&q=80", link: "#" },
    { id: "l7", title: "BOTANICAL_ATLAS", description: "Native flora and botanical reference data.", image: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80", link: "#" },
    { id: "l8", title: "BUILDINGS", description: "Building footprints and structure inventory.", image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80", link: "#" },
    ...
    { id: "l11", title: "CADASTRAL", description: "Land parcels and cadastral survey records.", image: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80", link: "#" },
    ...
    { id: "l13", title: "DTM", description: "Digital terrain model elevation data.", image: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&q=80", link: "#" },
    ...
    { id: "l20", title: "POPULATION_DEMOGRAPHY", description: "Population density and demographic layers.", image: "https://images.unsplash.com/photo-1551836022-deb4988cc6c0?w=600&q=80", link: "#" },
    ...
    { id: "l25", title: "TOPOGRAPHIC", description: "Topographic base map of Bahrain.", image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?w=600&q=80", link: "#" },
    { id: "l26", title: "VEGETATION", description: "Vegetation cover and green space mapping.", image: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&q=80", link: "#" },
    { id: "l27", title: "ZONES", description: "Land use and planning zone classification.", image: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=600&q=80", link: "#" },
  ],
};
